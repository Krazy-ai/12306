...
public final class StationCalculateUtil {
     ...
     */
    public static List<RouteDTO> throughRoute(List<String> stations, String startStation, String endStation) {
     ...
     */
    public static List<RouteDTO> takeoutRoute(List<String> stations, String startStation, String endStation) {
     ...
     * @return 出发站和终点站中间的站点
     */
    public static List<String> throughStation(List<String> stations, String startStation, String endStation) {
        List<String> stationsThrough = new ArrayList<>();
        int startIndex = stations.indexOf(startStation);
        int endIndex = stations.indexOf(endStation);
        if (startIndex < 0 || endIndex < 0 || startIndex >= endIndex) {
            return stationsThrough;
        }
        for (int i = startIndex; i <= endIndex; i++) {
            stationsThrough.add(stations.get(i));
        }
        return stationsThrough;
    }
